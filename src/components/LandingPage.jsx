  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="w-full px-6 pt-24 flex flex-col items-center" style={{ paddingBottom: '7rem' }}>
        ...
        <h1 className="text-5xl md:text-6xl font-black leading-[1.1] tracking-tight max-w-4xl text-center" style={{ marginBottom: '1.5rem' }}>
          Detecta y corrige{' '}
          ...
          {[
            ...
            <div key={label} className="glass rounded-[1.5rem] flex sm:flex-col items-center sm:items-center gap-4 sm:gap-2 sm:text-center" style={{ padding: '2rem' }}>
              ...
              <div className="flex-1 sm:flex-none text-left sm:text-center">
                <div className="text-3xl font-black text-[#e4e1ed]" style={{ marginBottom: '0.25rem' }}>{value}</div>
      ...
      <section className="w-full px-6" style={{ marginBottom: '8rem' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div className="text-center" style={{ marginBottom: '3.5rem' }}>
            <h2 className="text-3xl font-bold text-[#e4e1ed]" style={{ marginBottom: '0.75rem' }}>¿Cómo funciona?</h2>
            <p className="text-[#908fa0]" style={{ marginBottom: '0' }}>Tres pasos. Sin configuración. Sin servidores propios.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {STEPS.map((step) => (
              <div
                key={step.number}
                className="glass rounded-[1.5rem] flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-1 relative overflow-hidden"
                style={{ padding: '3rem 2.5rem', gap: '1.25rem' }}
              >
                <span
                ...
                <div
                  ...
                  style={{ background: `${step.color}20`, marginTop: '1rem' }}
                >
      ...
      <section className="w-full px-6" style={{ marginBottom: '8rem' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div className="text-center" style={{ marginBottom: '3rem' }}>
            <h2 className="text-3xl font-bold text-[#e4e1ed]" style={{ marginBottom: '0.75rem' }}>Todo lo que necesitas</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {FEATURES.map(({ icon, text }) => (
              <div key={text} className="glass rounded-[1rem] flex items-center gap-4" style={{ padding: '1.5rem 1.75rem' }}>
      ...
      <section className="w-full px-6" style={{ marginBottom: '8rem' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div
            ...
            style={{ padding: '2.5rem', background: 'rgba(255,183,131,0.05)', border: '1px solid rgba(255,183,131,0.2)' }}
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#ffb783]" style={{ marginBottom: '0.75rem' }}>Descargo de responsabilidad</h3>
                <div className="text-sm text-[#c7c4d7] leading-relaxed" style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  <p>
      ...
      <section className="w-full px-6 text-center" style={{ marginBottom: '6rem' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          >
            <h2 className="text-3xl font-bold text-[#e4e1ed]" style={{ marginBottom: '1rem' }}>
              ¿Listo para asegurar tus repos?
            </h2>
            <p className="text-[#908fa0]" style={{ marginBottom: '2rem' }}>Solo necesitas un GitHub Personal Access Token. Tarda 2 minutos.</p>
            <button
              onClick={() => navigate('/login')}
              className="rounded-[0.75rem] text-base font-bold transition-all duration-200 hover:-translate-y-1 active:scale-[0.98]"
              style={{
                padding: '1rem 3rem',
      ...
      {disclaimerOpen && (
        ...
        >
          <div
            className="glass rounded-[1.5rem] max-w-xl w-full"
            style={{ padding: '2rem' }}
          ...
          >
            ...
            <div className="text-sm text-[#c7c4d7] leading-relaxed" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <button
              onClick={() => setDisclaimerOpen(false)}
              className="w-full rounded-[0.75rem] font-semibold transition-all duration-200 hover:opacity-90"
              style={{ marginTop: '1.5rem', padding: '0.75rem', background: 'linear-gradient(135deg, #c0c1ff, #8083ff)', color: '#1000a9' }}
            >
              Entendido
            </button>
          </div>
